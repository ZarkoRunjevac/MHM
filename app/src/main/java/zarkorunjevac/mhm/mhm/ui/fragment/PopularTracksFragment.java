 ...
 */
public class PopularTracksFragment extends Fragment implements MVP.ProvidedLatestTracksPresenterOps{
    ...
    public  class ContentAdapter extends RecyclerView.Adapter<ContentAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            Picasso.with(PopularTracksFragment.this.getActivity())
        ...
        if(null!=trackList){
           ...
           // btn.setCompoundDrawables(getActivity().getResources().getDrawable(R.drawable.ic_keyboard_arrow_down_white_18dp),null,null,null);
            btn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Log.d("PopularTacksFragment", "onClick: " + adapter.getItemCount());
