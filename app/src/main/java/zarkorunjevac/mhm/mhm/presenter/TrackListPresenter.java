 ...
 */
public class TrackListPresenter extends GenericPresenter<MVP.RequiredTrackListPresenterOps,
        MVP.ProvidedTrackListDownloadModelOps,
        TrackListDownloadModel>
    ...
    public void onCreate(MVP.RequiredViewOps view) {
        ...
        resetFields();
        super.onCreate(TrackListDownloadModel.class,
                this);
    }
